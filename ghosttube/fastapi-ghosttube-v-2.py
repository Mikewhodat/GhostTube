#!/usr/bin/env python3
"""
YouTube Collector Agent with Tor Integration (FastAPI Version)
...
def check_prerequisites():
    ...
    for install_name, check_name in required_packages:
        try:
            ...
            subprocess.check_call([str(pip_bin), "install", install_name])
